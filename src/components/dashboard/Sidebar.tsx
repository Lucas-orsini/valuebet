...
const navItems = [
  ...
  { href: '/dashboard/ai-picks', label: 'IA Picks', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-900 min-h-screen p-4">
      <div className="mb-8">
        <h1 className="text-xl font-bold text-white px-4">Bet IA</h1>
      </div>
