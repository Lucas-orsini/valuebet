    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 bg-[#09090b] overflow-hidden pt-14">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto gap-8">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-tennis-500/30 bg-tennis-500/10"
        >
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-tennis-400 opacity-75" />
            <span className="relative inline-flex rounded-full h-2 w-2 bg-tennis-500" />
          </span>
          <span className="text-xs font-medium text-tennis-400">
        ...
        >
          <button className="h-11 px-6 rounded-lg bg-tennis-500 hover:bg-tennis-400 text-white text-sm font-medium transition-all duration-200 flex items-center gap-2 shadow-[0_0_24px_rgba(200,230,20,0.25)] hover:shadow-[0_0_32px_rgba(200,230,20,0.35)]">
          ...
          <button className="h-11 px-6 rounded-lg border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] text-zinc-300 text-sm font-medium transition-colors flex items-center gap-2">
            <Play size={14} className="text-tennis-400" />
            Voir une démo
          </button>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {["J", "M", "S", "T", "N"].map((initial, i) => (
                <div
                  key={i}
                  className="w-7 h-7 rounded-full bg-gradient-to-br from-tennis-500 to-tennis-400 flex items-center justify-center text-[10px] font-bold text-white border-2 border-[#09090b]"
                >
                  {initial}
                </div>
              ))}
          ...
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-tennis-400" fill="currentColor" viewBox="0 0 20 20">
        ...
        >
          ...
          <div className="text-center">
            <p className="text-xl sm:text-2xl font-bold text-tennis-400">70%</p>
      ...
      >
        <div className="w-6 h-10 rounded-full border border-white/10 flex items-start justify-center p-2">
          <motion.div
            ...
            className="w-1 h-2 rounded-full bg-tennis-400"
          />
        </div>
      </motion.div>
    </section>
