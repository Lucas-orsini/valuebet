    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 bg-[#09090b] overflow-hidden pt-14">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto gap-8">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10"
        >
        ...
        >
          <button className="h-11 px-6 rounded-lg bg-orange-500 hover:bg-orange-400 text-white text-sm font-medium transition-all duration-200 flex items-center gap-2 shadow-[0_0_24px_rgba(249,115,22,0.25)] hover:shadow-[0_0_32px_rgba(249,115,22,0.35)]">
          ...
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {["J", "M", "S", "T", "N"].map((initial, i) => (
                <div
                  key={i}
                  className="w-7 h-7 rounded-full bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center text-[10px] font-bold text-white border-2 border-[#09090b]"
                >
                  {initial}
                </div>
              ))}
        ...
        >
          ...
          <div className="text-center">
            <p className="text-xl sm:text-2xl font-bold text-orange-400">70%</p>
