...
export function Footer() {
  return (
    <footer className="border-t border-white/[0.06] bg-[var(--bg)] pt-16 pb-8 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="pt-8 border-t border-white/[0.05]">
          ...
          <div className="mt-6 p-4 rounded-xl bg-[var(--accent-alpha)] border border-[var(--border-accent)]">
