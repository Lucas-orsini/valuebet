  ...
  return (
    <section className="py-24 px-6 bg-[#09090b] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center gap-6">
        ...
        >
          <button className="h-11 px-6 rounded-lg bg-accent hover:bg-accent-light text-white text-sm font-medium transition-all duration-200 shadow-[0_0_24px_rgba(242,203,56,0.3)] hover:shadow-[0_0_32px_rgba(242,203,56,0.4)]">
